  ...
  <section class="w-full px-2.5 sm:px-9 mt-12 sm:mt-52">
    <div class="bg-[#BD5310] p-2.5 sm:p-6 rounded-xl max-w-[1098px] mx-auto relative">
      ...
      >
        ...
        <p>1. 若您註冊 LTrust 帳號是以第三方登入註冊時（Google、Line或Instagram，如下圖紅框所示），請完成下列步驟，方可登入活動網頁查看資訊：</p>

        <TextList
          :contents="[
            '請先至「登入頁面」按下「忘記密碼」；',
            '輸入您第三方登入的「 Email 帳號」，及「圖片驗證碼」後，按下「確認」按鈕；',
            '請至您的 Email 找到「會員密碼通知」信，並點選「設定新密碼」變更您的密碼；\n※若未在「收件夾」中找到信件，可前往至「垃圾信件」中查看3. 點選「基本資料」頁籤，填寫「學校名稱」。',
        ...
        <p>2. 若您是透過LTrust平台直接使用 Email 註冊帳號時（非透過第三方，如下圖紅框所示），可直接在本活動網頁，按下「登入」按鈕，登入您的帳號與密碼，即可查看您的活動紅利資訊。</p>
        ...
        <p>
          8.
          當每一週開啟新的比賽時，成績皆以當週新獲得的「任務紅利」計算；過去週次比賽的「任務紅利」將不會列當週新的比賽成績。
        </p>
